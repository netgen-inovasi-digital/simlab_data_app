...
<div class="row">
  <div class="col-md-12">
    <div class="card">
      ...
      <div>
        <input type="text" class="form-control" id="search" placeholder="Cari Dokumen" style="max-width: 300px; margin: 10px; margin-bottom: 0px;">
      </div>
            ...
            <div id="<?= $id ?>" class="dokumen-item flex " style="margin-left: <?= $level * 30; ?>px"
              ...
              <div class="d-flex justify-content-between align-items-center col-12">
                <div class="d-flex align-items-center gap-3">
                  <?php
                  if ($row->is_folder == "folder") {
                    echo '<i class="bi bi-caret-down"></i>';
                  } else {
                    echo '';
                  }
                  ?>
                  <i class="bi bi-folder-fill" title="Folder"></i> <!-- IKON DIUBAH DI SINI -->
